...
from pywebio.input import input_group, input, select, TEXT, PASSWORD, NUMBER
...
def display_firewall_rules():
    for firewall in registered_firewalls:
        ...
        # Example command to get firewall rules, replace with user input
        command = input("Enter the command to fetch firewall rules for firewall {}: ".format(firewall.management_ip), type=TEXT)
...
def add_firewall_rule(firewall_index, rule):
    firewall = registered_firewalls[firewall_index]
    firewall.connect_ssh()
    # Implement logic to add firewall rule using SSH command

# Function to update firewall rule
def update_firewall_rule(firewall_index, rule_id, new_rule):
    firewall = registered_firewalls[firewall_index]
    firewall.connect_ssh()
    # Implement logic to update firewall rule using SSH command

# Function to delete firewall rule
def delete_firewall_rule(firewall_index, rule_id):
    firewall = registered_firewalls[firewall_index]
    firewall.connect_ssh()
...
def firewall_automation():
    ...
    if registered_firewalls:
        ...
        manage_data = input_group("Firewall Rule", [
